...
@Component({
  selector: 'app-body-link-unit',
  templateUrl: './body-link-unit.component.html',
  styleUrls: ['./body-link-unit.component.css']
})
export class BodyLinkUnitComponent implements OnInit {
  ...
  constructor(private us: UserService, private cs: CommunityService, private ps: PostService) { }
