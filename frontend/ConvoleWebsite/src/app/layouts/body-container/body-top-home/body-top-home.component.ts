...
@Component({
  selector: 'app-body-top-home',
  templateUrl: './body-top-home.component.html',
  styleUrls: ['./body-top-home.component.css']
})
export class BodyTopHomeComponent implements OnInit {
  selected;
  currRoute = '';
  sortType;
  commData = [];
