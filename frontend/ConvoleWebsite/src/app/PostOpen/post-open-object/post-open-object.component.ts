...
@Component({
  selector: 'app-post-open-object',
  templateUrl: './post-open-object.component.html',
  styleUrls: ['./post-open-object.component.css', '../post-open-discussion/post-open-discussion.component.css']
})
export class PostOpenObjectComponent implements OnInit, OnDestroy {
