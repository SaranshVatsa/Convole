...
@Component({
  selector: 'app-post-open-discussion-without-image',
  templateUrl: './post-open-discussion-without-image.component.html',
  styleUrls: ['./post-open-discussion-without-image.component.css', '../post-open-discussion/post-open-discussion.component.css']
})
export class PostOpenDiscussionWithoutImageComponent implements OnInit, OnDestroy {
