...
@Component({
  selector: 'app-post-open-event',
  templateUrl: './post-open-event.component.html',
  styleUrls: ['./post-open-event.component.css', '../post-open-discussion/post-open-discussion.component.css']
})
export class PostOpenEventComponent implements OnInit, OnDestroy {
