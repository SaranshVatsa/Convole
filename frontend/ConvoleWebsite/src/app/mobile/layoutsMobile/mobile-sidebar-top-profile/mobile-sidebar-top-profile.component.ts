...
@Component({
  selector: 'app-mobile-sidebar-top-profile',
  templateUrl: './mobile-sidebar-top-profile.component.html',
  styleUrls: ['./mobile-sidebar-top-profile.component.css']
})
export class MobileSidebarTopProfileComponent implements OnInit {
  user = [];
  userFollowingData = [];
  firstName: string;
  lastName: string;
