...
@Component({
  selector: 'app-mobile-discussion-unit',
  templateUrl: './mobile-discussion-unit.component.html',
  styleUrls: ['./mobile-discussion-unit.component.css']
})
export class MobileDiscussionUnitComponent implements OnInit {
