...
@Component({
  selector: 'app-mobile-event-unit',
  templateUrl: './mobile-event-unit.component.html',
  styleUrls: ['./mobile-event-unit.component.css']
})
export class MobileEventUnitComponent implements OnInit {
