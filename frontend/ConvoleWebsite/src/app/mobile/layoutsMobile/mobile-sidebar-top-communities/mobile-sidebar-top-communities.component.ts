...
@Component({
  selector: 'app-mobile-sidebar-top-communities',
  templateUrl: './mobile-sidebar-top-communities.component.html',
  styleUrls: ['./mobile-sidebar-top-communities.component.css']
})
export class MobileSidebarTopCommunitiesComponent implements OnInit {
  community = [];
  communityName: string;
  communityMemberCount: any;
  communityDate: any;
  currDate: any;
  createdPast: string;
  joined = false;
