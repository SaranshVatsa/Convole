...
@Component({
  selector: 'app-mobile-post-create-object',
  templateUrl: './mobile-post-create-object.component.html',
  styleUrls: ['./mobile-post-create-object.component.css',
...
export class MobilePostCreateObjectComponent implements OnInit {
