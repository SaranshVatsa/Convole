...
@Component({
  selector: 'app-mobile-settings-page',
  templateUrl: './mobile-settings-page.component.html',
  styleUrls: ['./mobile-settings-page.component.css']
})
export class MobileSettingsPageComponent implements OnInit {
  @Input() settingsStatus = false;
  user = [];
  email: string;
  username: string;
