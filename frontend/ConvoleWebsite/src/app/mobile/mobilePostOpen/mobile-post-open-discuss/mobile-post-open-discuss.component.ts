...
@Component({
  selector: 'app-mobile-post-open-discuss',
  templateUrl: './mobile-post-open-discuss.component.html',
  styleUrls: ['./mobile-post-open-discuss.component.css']
})
export class MobilePostOpenDiscussComponent implements OnInit {
  @Input() post = [];
  @Input() discussData = [];
  ...
  ngOnInit() {
    ...
    if (this.us.uData['my_data']) {
      ...
      if (this.userAndDiscussionData && this.currentUserData) {
        let j;
