...
@Component({
  selector: 'app-mobile-post-open-discussion',
  templateUrl: './mobile-post-open-discussion.component.html',
  styleUrls: ['./mobile-post-open-discussion.component.css']
})
export class MobilePostOpenDiscussionComponent implements OnInit, OnDestroy {
