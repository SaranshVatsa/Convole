...
@Component({
  selector: 'app-discover-communities-card-mobile',
  templateUrl: './discover-communities-card-mobile.component.html',
  styleUrls: ['./discover-communities-card-mobile.component.css']
})
export class DiscoverCommunitiesCardMobileComponent implements OnInit {
  @Input() commData = [];
  commName: string;
  memberCount: number;
  communityDate: any;
